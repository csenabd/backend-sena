const ProyectoSenoService = require("../services/proyectoSeno.service");
const { hostback } = require("../config/config");

class ProyectoSenoController {
  constructor() {
    this.service = new ProyectoSenoService();
  }
...
module.exports = ProyectoSenoController;
